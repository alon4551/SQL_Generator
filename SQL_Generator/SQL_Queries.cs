...
namespace SQL_Generator
{
    public class Queries
    {
        ...
        public static string Delete(string table, List<Condition> Conditions, string Contition_Type)
        {
            return $"delete from {table} where {(Condition.SQL_Syntax(Conditions, Contition_Type))}";
        }
